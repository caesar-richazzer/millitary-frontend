...
export default function DepartmentsView({ safeOfficers, onSelectOfficer }) {
  ...
  const departmentsList = [
    ...
    { code: '834KJ-IO', title: 'IO', desc: 'Intelligence Officer & Security Branch', icon: 'bi-eye-fill' },
    { code: '834KJ-QM-tawi la siliha', title: 'QM-tawi la siliha', desc: 'Quarter Master & Armory Branch', icon: 'bi-box-seam-fill' },
    { code: '834KJ-ZAHANATI', title: '834KJ-ZAHANATI', desc: 'Medical Corps & Sick Bay', icon: 'bi-hospital-fill' },
    { code: '834KJ-UDM', title: 'UDM', desc: 'Unit Discipline Master Command', icon: 'bi-gavel' },
    { code: '834KJ-RADIO OPERATOR', title: 'RADIO OPERATOR', desc: 'Communications & Signals Wing', icon: 'bi-broadcast-pin' },
